...
namespace Drupal\spf\Plugin\DisplayVariant;
 ...
 * )
 */
class SPFBlockPageVariant extends BlockPageVariant {
  ...
  public function build() {
    ...
    foreach (Element::children($build) as $region) {
      ...
      $build[$region]['spf-placeholder-markup'] = ['#markup' => '<div spf-placeholder-markup></div>'];
    }
